...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zTiberiumsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTiberium denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTiberium denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTiberium denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTiberium denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTiberium denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTiberium denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTiberium denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTiberium denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTiberium denominations\n"
            "  }\n"
    ...
    UniValue ztiberiumObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        ztiberiumObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    ztiberiumObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zTiberiumsupply", ztiberiumObj));
