...
#   c) node1 mines 32 blocks, so now node 0 has 60001tiberium, node 1 has 4250tiberium, node2 has none.
#   d) node0 sends 601 tiberium to node2, in two transactions (301 tiberium, then 300 tiberium).
